...
convert Chevron@2x.png -rotate 180 "../$APP_NAME/Assets.xcassets/DownChevron.imageset/DownChevron@2x.png"
convert Chevron@3x.png -rotate 180 "../$APP_NAME/Assets.xcassets/DownChevron.imageset/DownChevron@3x.png"
EOF
...
function app_icon {
    parallel --progress -j 0 << EOF
svgexport AppIcon.xml "../$APP_NAME/Assets.xcassets/AppIcon.appiconset/Icon@2x.png" 120:120
svgexport AppIcon.xml "../$APP_NAME/Assets.xcassets/AppIcon.appiconset/Icon@3x.png" 180:180
svgexport AppIcon.xml "../$APP_NAME/Assets.xcassets/AppIcon.appiconset/Icon-iPadPro@2x.png" 167:167
svgexport AppIcon.xml "../$APP_NAME/Assets.xcassets/AppIcon.appiconset/Icon-iPad.png" 76:76
svgexport AppIcon.xml "../$APP_NAME/Assets.xcassets/AppIcon.appiconset/Icon-iPad@2x.png" 152:152
svgexport AppIcon.xml "../$APP_NAME/Assets.xcassets/AppIcon.appiconset/Icon-AppStore.png" 1024:1024
EOF
